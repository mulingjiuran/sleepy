...
class _page:
    ...
    background: str = getenv('sleepy_page_background', 'https://img.picui.cn/free/2025/03/19/67da6aaad0b12.png', str)
    learn_more: str = getenv('sleepy_page_learn_more', 'GitHub仓库', str)
    repo: str = getenv('sleepy_page_repo', 'https://github.com/mulingjiuran/sleepy', str)
